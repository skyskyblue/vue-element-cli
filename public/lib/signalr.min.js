          ...
          return new Promise(function(resolve, reject) {
            ...
            xhr.onload = function() {
              ...
              if (xhr.status >= 200 && xhr.status < 300) {
                resolve(
                  new HttpResponse(xhr.status, xhr.statusText, xhr.response || xhr.responseText)
                )
              } else {
                reject(
    ...
    function(module, __webpack_exports__, __webpack_require__) {
      ...
      var HandshakeProtocol = (function() {
        ...
        HandshakeProtocol.prototype.parseHandshakeResponse = function(data) {
          ...
          var messages = _TextMessageFormat__WEBPACK_IMPORTED_MODULE_0__['TextMessageFormat'].parse(
            messageData
          )
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              ...
              case 1:
                ...
                return [4, httpClient.post(url, { content: content, headers: headers })]
              case 2:
                response = _b.sent()
                logger.log(
                  _ILogger__WEBPACK_IMPORTED_MODULE_0__['LogLevel'].Trace,
    ...
    function(module, __webpack_exports__, __webpack_require__) {
      ...
      var HubConnectionBuilder = (function() {
        ...
        HubConnectionBuilder.prototype.build = function() {
          ...
          var connection = new _HttpConnection__WEBPACK_IMPORTED_MODULE_0__['HttpConnection'](
            this.url,
            httpConnectionOptions
          )
          return _HubConnection__WEBPACK_IMPORTED_MODULE_1__['HubConnection'].create(
            connection,
            this.logger || _Loggers__WEBPACK_IMPORTED_MODULE_3__['NullLogger'].instance,
            this.protocol || new _JsonHubProtocol__WEBPACK_IMPORTED_MODULE_2__['JsonHubProtocol']()
          )
        }
        return HubConnectionBuilder
      })()
    ...
    function(module, __webpack_exports__, __webpack_require__) {
      ...
      var HttpConnection = (function() {
        function HttpConnection(url, options) {
          ...
          this.httpClient =
            options.httpClient ||
            new _HttpClient__WEBPACK_IMPORTED_MODULE_0__['DefaultHttpClient'](this.logger)
          this.connectionState = 2
          this.options = options
        }
        HttpConnection.prototype.start = function(transferFormat) {
          transferFormat =
            transferFormat || _ITransport__WEBPACK_IMPORTED_MODULE_2__['TransferFormat'].Binary
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
                case 0:
                  ...
                  pollOptions = { abortSignal: this.pollAbort.signal, headers: {}, timeout: 9e4 }
                  if (
                    transferFormat ===
                    _ITransport__WEBPACK_IMPORTED_MODULE_3__['TransferFormat'].Binary
                  ) {
                ...
                case 2:
                  ...
                  if (response.statusCode !== 200) {
                    ...
                    closeError = new _Errors__WEBPACK_IMPORTED_MODULE_1__['HttpError'](
                      response.statusText,
                      response.statusCode
                    )
                    this.running = false
    ...
    function(module, __webpack_exports__, __webpack_require__) {
      ...
      var JsonHubProtocol = (function() {
        ...
        JsonHubProtocol.prototype.parseMessages = function(input, logger) {
          ...
          var messages = _TextMessageFormat__WEBPACK_IMPORTED_MODULE_4__['TextMessageFormat'].parse(
            input
          )
          var hubMessages = []
          for (var _i = 0, messages_1 = messages; _i < messages_1.length; _i++) {
